...
<div class="faqs-page">
	...
	<div class="themesflat-container">
		<div class="row">
			<div class="col-lg-10">
				<div class="card mb-3 wow fadeInUp animated">
					<div class="card-body one">
						<h2>Account</h2>
						<h6>Do I need to have an account to book cabs? </h6>
						...
						<h6>Why should I make an account with Butterfly Travels?</h6>
				...
				<div class="card mb-3 wow fadeInUp animated">
					<div class="card-body one">
						<h2>Booking</h2>
						<h6>When do I get the booking confirmation and the cab details?</h6>
				...
				<div class="card wow fadeInup animated">
					<div class="card-body one">
						<h2>Pricing</h2>
						<h6>When do I get the booking confirmation and the cab details?</h6>
						<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries
