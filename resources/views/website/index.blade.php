...
<!--main-banner-start-->
      <div class="tf-slide-form" style="background-image: url({{asset('website/homeimages/'.$home->image)}});background-size: cover;background-position: left center;">
         <div class="themesflat-container">
            <div class="slide-form t-al-center">
               <h1 class=" text-white wow fadeInUp" data-wow-delay="300ms"
               data-wow-duration="2000ms">{{$home->heading}}</h1>
            </div>
                        ...
                        <div class="newsletter-box text-center">
                           <div class="row justify-contnet-left">
                              <div class="col-lg-3 form-part">
                                 ...
                                 <select class="custom-select custom-select-sm" name="city">
                              ...
                              <div class="col-lg-2 form-part">
                                 ...
                                 <div class="form-group">
                                  <input type="text" name="pickupdate" id="search-from-date" class="form-control" placeholder="dd/mm/yyyy" autocomplete="off" required>
                                 </div>
                              </div>
                              ...
                              <div class="col-lg-2 form-part">
                                 ...
                                 <div class="form-group">
                                    <input type="time" class="form-control" name="pickuptime" type='time' value='now'>
                           ...
                           <button type="submit" name="submit" class=" search-btn btn theme-btn btn-radius btn-m w-25 mt-3" data-bs-toggle="modal" data-bs-target="#exampleModal"> <i class="fal fa-search"></i>Find Your Ride</button>
                        </div>
                     </form>
                  </div>
         ...
         <div class="themesflat-container">
            <div class="feature-v2-car-wrap">
               ...
               <div class="icon-box-feature">
                  @foreach($extrafeature as $feature)
                  <div class="icon-box-item">
                     <div class="image">
                        <img src="{{asset('website/extrafeature/'.$feature->image)}}" alt="">
                     </div>
                     <div class="content">
               ...
               <div class="category-car">
                    @foreach ($premium as $item)
                     <div class="category-car-item">
                        <img src="{{asset('website/homeimages/'.$item->image)}}" alt="homebanner" >
                        <div class="btn-main">
                           <a href="{{url('premiumview',$item->slug)}}" class="button_main_inner">
            ...
            <div class="explore-car-wrap">
               <div class="header-section-main mb-30">
                  ...
                  <div class="btn-read-more wow fadeInUp">
                     <a class="more-link" href="{{url('gallery')}}">
                        <span>View More</span>
               ...
               <div class="row">
                  ...
                  <div class="col-6 col-md-4 col-lg-4 col-xl-2 hvr-grow">
                     <a href="{{url('gallery')}}"  class="icon-box border-line ">
                        <div class="image-box-wrap">
                           <img src="{{asset('website/carbrands/'.$brands->carimage)}}" alt="">
                        </div>
            ...
            <div class="counter-car">
               ...
               <div class="counter-wrap tf-counter">
                  <div class="widget-counter t-al-center counter-v1">
                     ...
                     <div class="number-counter number" data-to="{{$ourachievement->happycust}}" data-speed="2000"
                        data-waypoint-active="yes">
                        {{$ourachievement->happycust}}
                     </div>
                     <p>Happy Customers</p>
                  </div>
                  <div class="widget-counter t-al-center counter-v1">
                     <img src="assets/img/icon-06.png" alt="">
                     <div class="number-counter number" data-to=" {{$ourachievement->corpsur}}" data-speed="2000"
                        data-waypoint-active="yes">
                        {{$ourachievement->corpsur}}
                     </div>
                     <p>Corporates Served</p>
                  </div>
                  <div class="widget-counter t-al-center counter-v1">
                     <img src="assets/img/icon-07.png" alt="">
                     <div class="number-counter number" data-to=" {{$ourachievement->experience}}" data-speed="2000"
                        data-waypoint-active="yes">
                        {{$ourachievement->experience}}
                     </div>
                     <p> Years Of Service Excellence</p>
                  </div>
                  <div class="widget-counter t-al-center counter-v1">
                     <img src="assets/img/icon-08.png" alt="">
                     <div class="number-counter number" data-to=" {{$ourachievement->surcity}}" data-speed="2000"
                        data-waypoint-active="yes">
                        {{$ourachievement->surcity}}
                     </div>
         ...
         <div class="themesflat-container">
            <div class="take-appointement">
               <div class="take-appointement-content">
                  ...
                  <div class="btn-main">
                     <a href="{{url('contactUs')}}" class="button_main_inner">
