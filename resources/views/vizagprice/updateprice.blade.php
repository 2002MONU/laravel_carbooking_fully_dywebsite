   ...
   <div class="container-full">
      ...
      <div class="content-header">
         <div class="d-flex align-items-center">
            <div class="me-auto">
               <h4 class="page-title">Update Vizag Packages Details</h4>
                  ...
                  <div class="card-body">
                     ...
                     <div class="tab-content">
                        <div class="tab-pane show active" id="input-types-preview">
                           <div class="row">
                              <div class="col-lg-6">
                                 <form method="POST" action="{{url('vizagpupdate',$result->id)}}" enctype="multipart/form-data">
                                    @csrf
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                       ...
                                       <div class="text-danger" id="acpriceError"></div>
                                    ...
                                    <div class="mb-3">
                                       ...
                                       <div class="text-danger" id="seatError"></div>
                                       @if($errors->has('seats'))
                                    ...
                                    <div class="mb-3">
                                      ...
                                      <div class="text-danger" id="extrakmError"></div>
                                    ...
                                    <div class="mb-3">
                                       ...
                                       <div class="form-group">
                                          ...
                                          <select class="form-control select2" name="city_id"  style="width: 100%;">
                                            ...
                                            <option value="{{$item->id}}" @if($item->id == $result->city_id) selected @endif>{{$item->cityname}}</option>
                                            @endforeach
                                    ...
                                    <div class="mb-3">
                                       ...
                                       <img src="{{asset('website/vizagcity/'.$result->image)}}" alt="homebanner" style="width:50px;height:50px">
                                     <br>
