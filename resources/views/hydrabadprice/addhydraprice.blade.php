                  ...
                  <div class="card-body">
                     ...
                     <div class="tab-content">
                        <div class="tab-pane show active" id="input-types-preview">
                           <div class="row">
                              <div class="col-lg-6">
                                 <form method="POST" action="{{url('hydrabadpricead')}}" enctype="multipart/form-data">
                                    @csrf
                                    <div class="mb-3">
                                       <label for="simpleinput" class="form-label">Car Type</label>
                                       <input type="text" id="simpleinput" name="cartype" class="form-control" value="{{old('cartype')}}" placeholder="Innova Crysta ">
                                    ...
                                    <div class="mb-3">
                                       ...
                                       <input type="text" id="acprice" name="acprice" class="form-control"  value="{{old('acprice')}}" placeholder="11900">
                                    ...
                                    <div class="mb-3">
                                       ...
                                       <input type="text" id="price" name="price" class="form-control"  value="{{old('price')}}" placeholder="11470">
                                    ...
                                    <div class="mb-3">
                                       ...
                                       <input type="text" id="simpleinput" name="fueltype" class="form-control" value="{{old('fueltype')}}" placeholder="Petrol/Diesal">
                                    ...
                                    <div class="mb-3">
                                       ...
                                       <input type="text" id="seat" name="seats" class="form-control" value="{{old('seats')}}" placeholder="8 ">
                                    ...
                                    <div class="mb-3">
                                       ...
                                       <input type="text" id="extrakm" name="extrakm" class="form-control" placeholder="24" value="{{old('extrakm')}}">
