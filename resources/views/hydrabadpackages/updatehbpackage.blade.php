                  ...
                  <div class="card-body">
                     ...
                     <div class="tab-content">
                        <div class="tab-pane show active" id="input-types-preview">
                           <div class="row">
                              <div class="col-lg-6">
                                 <form method="POST" action="{{url('hydrapackageup',$package->id)}}" enctype="multipart/form-data">
                                    @csrf
                                    <div class="mb-3">
                                       <label for="simpleinput" class="form-label">City</label>
                                       <input type="text" id="simpleinput" name="city" class="form-control" value="{{$package->city}}">
                                       @if($errors->has('city'))
                                    ...
                                    <div class="mb-3">
                                       ...
                                       <img src="{{asset('website/hydrapackages/'.$package->image)}}" alt="homebanner" style="width:50px;height:50px">
                                     <br>
