   ...
   <div class="container-full">
      ...
      <div class="content-header">
         <div class="d-flex align-items-center">
            <div class="me-auto">
               <h4 class="page-title">Vizag Update Packages Details</h4>
                  ...
                  <div class="card-body">
                     ...
                     <div class="tab-content">
                        <div class="tab-pane show active" id="input-types-preview">
                           <div class="row">
                              <div class="col-lg-6">
                                 <form method="POST" action="{{url('vizagcityup',$package->id)}}" enctype="multipart/form-data">
                                    @csrf
                                    <div class="mb-3">
                                       <label for="simpleinput" class="form-label">City</label>
                                       <input type="text" id="simpleinput" name="cityname" class="form-control" value="{{$package->cityname}}">
                                    ...
                                    <div class="mb-3">
                                       ...
                                       <img src="{{asset('website/vizagcity/'.$package->cityimage)}}" alt="homebanner" style="width:50px;height:50px">
                                     <br>
