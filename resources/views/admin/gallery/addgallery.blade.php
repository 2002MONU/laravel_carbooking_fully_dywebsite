   ...
   <div class="container-full">
      ...
      <div class="content-header">
         <div class="d-flex align-items-center">
            <div class="me-auto">
               <h4 class="page-title">Add Galler Image </h4>
                  ...
                  <div class="card-body">
                     ...
                     <div class="tab-content">
                        <div class="tab-pane show active" id="input-types-preview">
                           <div class="row">
                              <div class="col-lg-6">
                                 <form method="POST" action="{{url('gallerypost')}}" enctype="multipart/form-data">
                                    @csrf
                                 <div class="mb-3">
                                       <label for="example-email" class="form-label">Gallery Image</label>
                                       <input type="file" id="fileInput"  name="image" class="form-control">
                                      <span class="text-danger">(NOTE-PNG,JPG,JPEG,Size-1MB,Min_Dim-800X400,Max_Dim-1500X850)</span>
