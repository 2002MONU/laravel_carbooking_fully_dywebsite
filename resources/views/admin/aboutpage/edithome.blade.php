            ...
            <div class="col-lg-6">
               <div class="card">
                  <div class="card-body">
                     ...
                     <form method="POST" action="{{url('aboutedit',$aboutpage->id)}}" enctype="multipart/form-data" id="myForm">
                        @csrf
                        <div class="mb-3">
                           <label for="happycust" class="form-label">Heading</label>
                           <input type="text" name="heading" class="form-control" value="{{$aboutpage->heading}}" placeholder="About Heading" >
                       ...
                       <div class="mb-3">
                        ...
                        <img src="{{asset('website/aboutpage/'.$aboutpage->image)}}" style="width:50px;height:50px;"><br>
