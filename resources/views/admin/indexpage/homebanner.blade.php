                  ...
                  <div class="card-body">
                     ...
                     <div class="tab-content">
                        <div class="tab-pane show active" id="input-types-preview">
                           <div class="row">
                              <div class="col-lg-6">
                                 <form method="POST" action="{{url('homepost',$home->id)}}" enctype="multipart/form-data">
                                    @csrf
                                    <div class="mb-3">
                                       <label for="simpleinput" class="form-label">Text</label>
                                       <input type="text" id="simpleinput" name="heading" class="form-control" value="{{$home->heading}}">
                                    ...
                                    <div class="mb-3">
                                       ...
                                       <input type="file" id="fileInput"  name="bgimage" class="form-control">
                                       <img src="{{asset('website/homeimages/'.$home->image)}}" alt="homebanner" style="width:50px;height:50px">
                                     <br> <span class="text-danger">(NOTE-PNG,JPG,JPEG,Size-1MB,Min_Dim-1600X1000,Max_Dim-4000X2000)</span>
                                      <span id="message" class="text-danger"></span>
                                       @if($errors->has('bgimage'))
                                       <div class="error text-danger">{{ $errors->first('bgimage') }}
                                       </div>
                                         @endif
                                    </div>
