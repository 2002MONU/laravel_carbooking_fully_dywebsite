   ...
   <div class="container-full">
      ...
      <div class="content-header">
         <div class="d-flex align-items-center">
            <div class="me-auto">
               <h4 class="page-title">Home Premium Details Update</h4>
               @if(Session('success'))
                  ...
                  <div class="card-body">
                     ...
                     <div class="tab-content">
                        <div class="tab-pane show active" id="input-types-preview">
                           <div class="row">
                              <div class="col-lg-6">
                                 <form method="POST" action="{{url('updatepremiumtravels',$premium->id)}}" enctype="multipart/form-data">
                                    @csrf
                                    <div class="mb-3">
                                       <label for="simpleinput" class="form-label">Heading</label>
                                       <input type="text" id="simpleinput" name="heading" class="form-control" value="{{$premium->heading}}" placeholder="Topics">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" id="simpleinput" name="slug" class="form-control" value="{{$premium->slug}}" placeholder="slug">
                                        @if($errors->has('slug'))
                                     ...
                                     <div class="mb-3">
                                        ...
                                        <textarea type="text" id="Paragraph" name="para1" placeholder="Write Here..." class="form-control" value="" cols="10" rows="5">{{$premium->para1}}</textarea>
                                        @if($errors->has('para1'))
                                     ...
                                     <div class="mb-3">
                                        ...
                                        <textarea type="text" id="simpleinput" name="para2" class="form-control" placeholder="Write Here..." value="" cols="10" rows="5">{{$premium->para2}}</textarea>
                                        @if($errors->has('para2'))
                                    ...
                                    <div class="mb-3">
                                       ...
                                       <img src="{{asset('website/homeimages/'.$premium->image)}}" alt="homebanner" style="width:50px;height:50px">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="status" class="form-control select2" style="width: 100%;">
                                          ...
                                          <option value="1" {{ $premium->status == 1 ? 'selected' : '' }}>Active</option>
                                          <option value="0" {{ $premium->status == 0 ? 'selected' : '' }}>Inactive</option>
