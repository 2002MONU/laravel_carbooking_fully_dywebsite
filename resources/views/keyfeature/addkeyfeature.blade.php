                  ...
                  <div class="card-body">
                     ...
                     <div class="tab-content">
                        <div class="tab-pane show active" id="input-types-preview">
                           <div class="row">
                              <div class="col-lg-6">
                                 <form method="POST" action="{{url('addkeyfeaturedPost')}}" enctype="multipart/form-data">
                                    @csrf
                                    <div class="mb-3">
                                       <label for="simpleinput" class="form-label">Title</label>
                                       <input type="text" id="simpleinput" name="title" class="form-control" value="{{old('city')}}" placeholder="Enter Your Title">
                                       @if($errors->has('title'))
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea type="text" id="simpleinput" name="paragraph" class="form-control" value="{{old('city')}}" cols="6" rows="4" placeholder="Enter Your Paragraph"></textarea>
