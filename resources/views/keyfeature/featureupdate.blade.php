                  ...
                  <div class="card-body">
                     ...
                     <div class="tab-content">
                        <div class="tab-pane show active" id="input-types-preview">
                           <div class="row">
                              <div class="col-lg-6">
                                 <form method="POST" action="{{url('keyfeatureupdate',$keyfeature->id)}}" enctype="multipart/form-data">
                                    @csrf
                                    <div class="mb-3">
                                       <label for="simpleinput" class="form-label">Title</label>
                                       <input type="text" id="simpleinput" name="title" class="form-control" value="{{$keyfeature->title}}">
                                       @if($errors->has('title'))
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea type="text" id="simpleinput" name="paragraph" class="form-control"  cols="6" rows="4">{{$keyfeature->paragraph}}</textarea>
                                    ...
                                    <div class="mb-3">
                                       ...
                                       <img class="bg-dark" src="{{asset('website/keyfeature/'.$keyfeature->image)}}" alt="homebanner" style="width:50px;height:50px">
                                     <br>
